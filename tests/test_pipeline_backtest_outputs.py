...
def test_build_summary_tables_and_write_outputs() -> None:
    ...
    try:
        ...
        assert (output_dir / "return_series.csv").exists()
        assert (output_dir / "turnover_history.csv").exists()
        assert (output_dir / "transaction_cost_history.csv").exists()
        assert (output_dir / "rebalance_flags.csv").exists()
        assert (output_dir / "weights_start_history.csv").exists()
        assert (output_dir / "weights_end_history.csv").exists()
